...
<template>
  ...
  >
    <div v-if="plan.recommended" class="absolute top-4 right-4">
      <span class="bg-[#25D366] text-white px-3 py-1 rounded-full text-sm">Recomendado</span>
    </div>
    <div class="p-8">
      ...
      <ul class="space-y-4 mb-8">
        <li v-for="feature in plan.features" :key="feature" class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#25D366] mr-2" viewBox="0 0 20 20" fill="currentColor">
