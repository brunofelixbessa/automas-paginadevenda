  ...
  <div>
    ...
    <section class="bg-[#128C7E] text-white py-16">
      <div class="container mx-auto px-4 text-center">
        <h2 class="text-3xl font-bold mb-6">Pronto para revolucionar seu atendimento?</h2>
        <p class="text-xl mb-8">Comece agora e transforme a maneira como você gerencia suas conversas no WhatsApp</p>
        <button class="bg-white text-[#128C7E] font-bold py-3 px-8 rounded-full text-lg hover:bg-gray-100 transition-colors">
    ...
    <footer class="bg-gray-900 text-white py-12">
      <div class="container mx-auto px-4">
        <div class="text-center">
          <p>&copy; 2024 WhatsApp Management System. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  </div>
